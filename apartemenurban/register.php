   ...
   $c_pass = "123123123";
    ...
    if($conn){
        if(strlen($password)>30 || strlen($password)<6){
            ...
            $sqlCheckName = "SELECT * FROM sales_login  WHERE name LIKE '$name'";
            ...
            if(mysqli_num_rows($nameQuery) > 0 ){
                ...
                $sql_register = "INSERT INTO sales_login (name, username, password, c_pass) VALUES ('$name', '$username','$password','$c_pass')";
