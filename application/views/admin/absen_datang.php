          ...
          <div class="col-lg">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Data Absen Datang</h1>
                ...
                <table id="myTable" class="table">
                    ...
                    <tbody>
                        <?php $i=1; foreach($absen_datang as $p) :?>
                        <tr>
                            <td><?= $i++ ?></td>
                            <td><?= $p['nama'] ?></td>
                            <td><?= $p['lokasi'] ?></td>
                            <td><?= $p['tanggal'] ?></td>
                            <td><img src="<?php echo base_url('android_register_login/absen_datang/'.$p['foto']); ?>"/>
                            </td> 
                            <td>      
                            <a href="<?= base_url() ?>admin/hapus_absen_datang/<?= $p['id'] ?>" class="btn btn-danger"><i class="fas fa-ban"></i> </a>
                        </td>
                        </tr>
                        <?php endforeach?>
                    </tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
          <?= form_open_multipart('admin/export_excel_datang')?>
          <form action="<?= base_url()?>admin/export_excel_datang" method="post" >
          <table>
            <tr>
              <td>
